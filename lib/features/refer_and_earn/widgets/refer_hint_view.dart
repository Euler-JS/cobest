            ...
            Column(children: hintList.map((hint) => Row(children: [
                Container(margin: const EdgeInsets.all(Dimensions.paddingSizeExtraSmall),
                  ...
                  decoration: BoxDecoration(color: Provider.of<ThemeController>(context).darkTheme ?
                    ColorHelper.darken(Theme.of(context).colorScheme.onPrimary, 1) : Theme.of(context).colorScheme.onPrimary,
                    shape: BoxShape.circle,
                    boxShadow: [BoxShadow(color: Theme.of(context).textTheme.bodyLarge!.color!.withValues(alpha:0.10),
