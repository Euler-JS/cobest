...
class RemoveFromWishlistBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.only(bottom: Dimensions.paddingSizeButton, top: Dimensions.paddingSizeDefault),
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Container(width: Dimensions.paddingSizeButton, height: Dimensions.paddingSizeExtraSmall, decoration: BoxDecoration(
            color: Theme.of(context).hintColor.withValues(alpha:.5), borderRadius: BorderRadius.circular(Dimensions.paddingSizeLarge),
        )),
        ...
        Text(getTranslated('remove_from_wish', context)!, style: textBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).textTheme.bodyLarge?.color)),

        Padding(
          padding: const EdgeInsets.only(top: Dimensions.paddingSizeSmall, bottom: Dimensions.paddingSizeLarge,),
          child: Text('${getTranslated('remove_this_item', context)}', style: textRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color),),
        ),
