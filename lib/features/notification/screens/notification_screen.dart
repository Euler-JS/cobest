...
import 'package:cobes_marketplace/features/notification/widget/notification_item_widget.dart';
import 'package:cobes_marketplace/features/notification/widget/notification_shimmer_widget.dart';
...
class _NotificationScreenState extends State<NotificationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(appBar:  CustomAppBar(title: getTranslated('notification', context), onBackPressed: (){
      ...
      body: Provider.of<AuthController>(context, listen: false).isLoggedIn() ? Consumer<NotificationController>(
