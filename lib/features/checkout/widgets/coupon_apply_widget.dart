...
import 'package:cobes_marketplace/features/checkout/widgets/coupon_bottom_sheet_widget.dart';
          ...
          child: Container(height: 50, width: MediaQuery.of(context).size.width,
            ...
            InkWell(onTap: ()=> showModalBottomSheet(context: context,
              ...
              child: Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  Text('${getTranslated('add_coupon', context)}', style: textMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).textTheme.bodyLarge?.color),),
