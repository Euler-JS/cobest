        ...
        builder: (context, orderProvider, _) {
          return Stack(children: [
            ...
            Padding(padding: const EdgeInsets.fromLTRB(0, Dimensions.paddingSizeDefault, Dimensions.paddingSizeDefault,
              ...
              child: Container(width: MediaQuery.of(context).size.width *.75, height: 180,
                ...
                child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start,children: [
                  ...
                  Padding(padding: const EdgeInsets.only(top: Dimensions.paddingSizeLarge, bottom: Dimensions.paddingSizeExtraSmall),
                    child: Text(offlinePaymentModel.methodName ?? '', style: textBold.copyWith(
                      ...
                      itemBuilder: (context, index){
                        return Padding(padding: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeExtraExtraSmall),
                          child: Column(children: [
                            Text(
                              '${offlinePaymentModel.methodFields?[index].inputName??''} : '.replaceAll("_", " ").capitalize(),
                              style: textRegular.copyWith(fontSize: Dimensions.fontSizeDefault),
                            ),

                            Text(
                              (offlinePaymentModel.methodFields?[index].inputData??'').replaceAll('_', " ").capitalize(),
